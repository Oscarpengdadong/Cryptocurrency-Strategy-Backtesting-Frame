...
plt.savefig(os.path.join(out_dir, "ADA_price_with_signals.png"))
...
plt.text(0.5, 0.8, f"Max Drawdown: {max_drawdown:.2f}",
         ...
         fontsize=10, color='green',
         verticalalignment='top')
plt.savefig(os.path.join(out_dir, "ADA_equity_curve.png"))
...
plt.legend()
plt.title("RSI")
plt.savefig(os.path.join(out_dir, "ADA_rsi_curve.png"))
